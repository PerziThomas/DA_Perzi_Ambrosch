...
- The `Translate`{.JavaScript} tag can be used in a self-closing form with a property <code>id</code> referencing the translation property name in the resource files.
