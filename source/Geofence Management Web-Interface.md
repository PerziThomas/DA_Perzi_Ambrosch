...
![The two labels (top left) are displayed at the same point and completely outside their corresponding polygons (bottom right).](source/figures/React_Profiler_after.png "Screenshot"){#fig:stress_one width=90%}
\
