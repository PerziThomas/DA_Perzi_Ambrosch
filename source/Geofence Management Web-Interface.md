...
![The two label (top left) are displayed on the same point and completely outside their corresponding polygons (bottom right).](source/figures/Label_precision_problem.png "Screenshot"){#fig:stress_one width=90%}
\
